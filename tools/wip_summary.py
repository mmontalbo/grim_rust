    ...
    "sections": [
        ...
        },
        {
            ...
            "body": [
                ...
                "Launch the retail capture build with grctl (copy via `grctl retail copy`, manage telemetry hooks via `grctl retail hooks`, and run `grctl retail start` for captures). Use `grctl retail hooks disable` when you need a clean retail session.",
