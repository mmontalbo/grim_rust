    ...
    "sections": [
        ...
        },
        {
            ...
            "body": [
                ...
                "Launch the retail capture build with grctl (copy via `grctl retail copy` and run `grctl retail start` for captures). Pass `--vanilla` when you need a clean retail session without the shim.",
